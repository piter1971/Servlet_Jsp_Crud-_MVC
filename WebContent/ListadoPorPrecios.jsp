...
<body class="fondoProyecto">
	<form name="porPrecio" method="get" action="ControladorProductos">
		<div id="contenedorCabecera">
			...
			<div class="titulo">
				<h1>
					Mostrando todo los articulos con precio entre: <%=request.getAttribute("precio1")%> y <%=request.getAttribute("precio2")%></h1>
			</div>
		...
		<table class="tablaReg">
			...
			<c:forEach var="tempProd" items="${recibeListaPrecio}">
