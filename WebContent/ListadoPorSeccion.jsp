...
<form name="porSeccion" method="get" action="ControladorProductos" >
	<div id="contenedorCabecera">
		<div class="btnLista">
		<input type="submit" name="instruccionn" value="Ir a lista completa">
		</div>
		<div class="titulo">
		<h1 >Mostrando todo los articulos con seccion : <%=request.getAttribute("opcionElegida") %></h1>
		</div>
	...
	<table class="tablaReg">
			...
			<c:forEach var="tempProd" items="${enviarListaPorSeccion}">
